...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into categories(name) value('$category')");
    if ($query) {
echo "<script>alert('category added succesifuly');</script>";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-file-text-o"></i>add new product category</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="arttype" name="category" type="text"
                                                required="true">
                                        </div>
                                    </div>

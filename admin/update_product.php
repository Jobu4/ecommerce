...
if(isset($_POST['submit']))
  {
    ...
    $eid=$_GET['editid'];
    $query=mysqli_query($con, "UPDATE products SET Title='$title',ArtType='$arttype',SellingPricing='$sprice',Description='$description' where ID='$eid'");
    if ($query) {
  
    echo "<script>alert('Product updating.');</script>";
            ...
            <section class="wrapper">
                ...
                <div class="row">
                    <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                        <?php
                           $cid=$_GET['editid'];
                           $ret=mysqli_query($con,"SELECT * FROM products WHERE ID='$cid'");
                           $cnt=1;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <img src="images/<?php echo $row['Image'];?>" width="200" height="150"
                                                ...
                                                href="changeimage.php?editid=<?php echo $row['apid'];?>"> &nbsp; Edit
                                                Image</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control m-bot15" name="arttype" id="arttype">
                                                ...
                                                <?php $query2=mysqli_query($con,"SELECT * FROM categories");

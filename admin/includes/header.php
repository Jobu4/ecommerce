...
?>
       <!--logo start-->
       <a href="dashboard.php" class="logo"><span class="lite"><strong> Admin Panel</strong></span></a>
       <!--logo end-->
...
while ($row1=mysqli_fetch_array($ret1)) { ?>
                       <li>
                           <a href="view-enquiry-detail.php?viewid=<?php echo $row1['ID'];?>">
                               ...
                               New Order from <?php echo $row1['FullName'];?>
                               <span class="small italic pull-right"></span>
                           </a>
                       </li>

                       <?php }} else{ ?>
                       <p align="center">No new order found</p>

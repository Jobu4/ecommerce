...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "UPDATE users SET Name='$name',MobileNumber='$mobnum',Email='$email'  WHERE ID='$eid'");
    if ($query) {
  
    echo "<script>alert('user credentials updated succesifuly');</script>";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="name" name="name" type="text"
                                                required="true" value="<?php  echo $row['Name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="email" name="email" type="email"
                                                required="true" value="<?php  echo $row['Email'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">
                                          Change  Profile Picture Here</label>
                                        <div class="col-sm-10">
                                            <img src="images/<?php echo $row['Profilepic'];?>" width="200" height="150"
                                                value="<?php  echo $row['Profilepic'];?>"><a
                                                href="changepropic.php?imageid=<?php echo $row['ID'];?>"
                                                class="btn btn-success"> Edit Image</a>
                                        </div>

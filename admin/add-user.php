...
$proimg=md5($img).$extension;
    ...
    $query=mysqli_query($con, "insert into users(Name,MobileNumber,Email,Profilepic) value('$name','$mobnum','$email','$proimg')");
    if ($query) {
echo "<script>alert('user has been succesifuly');</script>";
...
<head>
    <title>Welcome here just add new users</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-file-text-o"></i>Add new users</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="mobnum" maxlength="10" name="mobnum"
                                                type="number" required="true" pattern="[0-9]+">
                                        </div>
                                    </div>
                                    <div class="form-group">

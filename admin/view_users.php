    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-table"></i> View all users</h3>
                        <ol class="breadcrumb">
                        ...
                        <section class="panel">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><a href="update_user.php?editid=<?php echo $row['ID'];?>"
                                            class="btn btn-success">Edit</a> || <a
                                            href="view_users.php?delid=<?php echo $row['ID'];?>"

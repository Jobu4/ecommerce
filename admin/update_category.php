...
if(isset($_POST['submit']))
  {
    ...
    $category=$_POST['arttype'];
    
  $eid=$_GET['editid'];
   
    $query=mysqli_query($con, "UPDATE categories SET name='$category' where ID='$eid'");
    if ($query) {
  
    echo "<script>alert('Category updated succesifuly');</script>";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-file-text-o"></i>Update Category</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal " method="post" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="arttype" name="arttype" type="text"

...
$artpic=md5($appic).$extension;
    ...
    $query=mysqli_query($con, "UPDATE products SET Image ='$artpic' WHERE ID='$cid'");
    if ($query) {
    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Product Image</h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
                            <li><i class="icon_document_alt"></i>AProduct Image</li>
                            <li><i class="fa fa-file-text-o"></i>Update Product Image</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="title" name="title" type="text"
                                                required="true" value="<?php  echo $row['Title'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
